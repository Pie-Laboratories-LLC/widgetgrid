(function(){try{if(typeof document<`u`){var e=document.createElement(`style`);e.appendChild(document.createTextNode(`.widget-topbar[data-v-8396cb96]{z-index:10;background:#150a2e;align-items:center;height:255px;padding-left:40px;transition:height .25s;display:flex;position:fixed;top:0;left:0;right:0}.widget-topbar.topbar-collapsed[data-v-8396cb96]{height:64px}.topbar-logo[data-v-8396cb96]{cursor:pointer;width:auto;height:255px;transition:height .25s;display:block}.topbar-collapsed .topbar-logo[data-v-8396cb96]{height:64px}.topbar-menu-slot[data-v-8396cb96]{flex:1;justify-content:flex-end;align-items:center;gap:20px;padding-right:40px;display:flex}.topbar-icon[data-v-8396cb96]{color:#f4ead9;cursor:pointer;background:0 0;border:none;border-radius:6px;padding:6px;line-height:0;position:relative}.topbar-icon[data-v-8396cb96]:hover,.topbar-icon[data-v-8396cb96]:focus-visible{background:#f4ead91f}.topbar-icon svg[data-v-8396cb96]{width:30px;height:30px}.topbar-icon[data-v-8396cb96]:disabled{opacity:.35;cursor:default}.topbar-icon[data-v-8396cb96]:disabled:hover{background:0 0}.topbar-badge[data-v-8396cb96]{color:#fff;text-align:center;background:#e5322d;border-radius:999px;min-width:14px;height:14px;padding:0 2px;font-size:10px;font-weight:700;line-height:14px;position:absolute;bottom:2px;right:2px;box-shadow:0 0 0 2px #150a2e}/*$vite$:1*/`)),document.head.appendChild(e)}}catch(e){console.error(`vite-plugin-css-injected-by-js`,e)}})();
import { createBlock, createCommentVNode, createElementBlock, createElementVNode, normalizeClass, openBlock, resolveDynamicComponent } from "vue";
...
var _plugin_vue_export_helper_default = (e, t) => {
	...
	return n;
}, ASSET_BASE = "/widgets/topbar-assets/", OWNER_TOKEN_KEY = "widgetgrid:ownerToken", _sfc_main = {
	name: "TopBarWidget",
	props: {
		data: {
			type: Object,
	...
	created() {
		window.addEventListener("widgetgrid:navigate", this.onNavigate), window.addEventListener("widgetgrid:scroll", this.onScroll), window.addEventListener("widgetgrid:new-post", this.onNewPost), window.addEventListener("widgetgrid:chat-event", this.onChatEvent), this.unsubscribePresence = subscribeOwnerPresence((e) => {
			this.ownerOnline = e;
		}), import(
			/* @vite-ignore */
			"/widgets/login.js"
	...
	beforeUnmount() {
		window.removeEventListener("widgetgrid:navigate", this.onNavigate), window.removeEventListener("widgetgrid:scroll", this.onScroll), window.removeEventListener("widgetgrid:new-post", this.onNewPost), window.removeEventListener("widgetgrid:chat-event", this.onChatEvent), this.unsubscribePresence();
	},
	methods: {
		assetUrl(e) {
			return ASSET_BASE + e;
		...
		onChatEvent() {
			(localStorage.getItem(OWNER_TOKEN_KEY) || this.activeView !== "chat") && (this.hasNewChatMessage = !0);
		},
		onLogoClick() {
	...
	"height",
	"alt"
], _hoisted_2 = { class: "topbar-menu-slot" }, _hoisted_3 = {
	key: 0,
	viewBox: "0 0 24 24",
	fill: "none",
	stroke: "currentColor",
	...
	fill: "currentColor",
	"aria-hidden": "true"
}, _hoisted_8 = ["disabled"], _hoisted_9 = {
	key: 0,
	viewBox: "0 0 24 24",
	fill: "none",
	stroke: "currentColor",
...
function _sfc_render(e, t, n, r, i, o) {
	return openBlock(), createElementBlock("header", { class: normalizeClass(["widget widget-topbar", { "topbar-collapsed": i.collapsed }]) }, [createElementVNode("img", {
		src: i.collapsed ? o.assetUrl("logo-h64.png") : o.assetUrl("logo-h255.png"),
		width: i.collapsed ? 85 : 339,
		height: i.collapsed ? 64 : 255,
		alt: n.data?.alt || "Pie Laboratories LLC",
		class: "topbar-logo",
		onClick: t[0] ||= (...e) => o.onLogoClick && o.onLogoClick(...e)
	}, null, 8, _hoisted_1), createElementVNode("nav", _hoisted_2, [
		createElementVNode("button", {
			type: "button",
			class: "topbar-icon",
			title: "Home",
			"aria-label": "Home",
			onClick: t[1] ||= (...e) => o.onHomeClick && o.onHomeClick(...e)
		}, [i.activeView === "blog" ? (openBlock(), createElementBlock("svg", _hoisted_3, [...t[4] ||= [
			createElementVNode("path", { d: "M5 12l-2 0l9 -9l9 9l-2 0" }, null, -1),
			createElementVNode("path", { d: "M5 12v7a2 2 0 0 0 2 2h10a2 2 0 0 0 2 -2v-7" }, null, -1),
			createElementVNode("path", { d: "M9 21v-6a2 2 0 0 1 2 -2h2a2 2 0 0 1 2 2v6" }, null, -1)
		]])) : (openBlock(), createElementBlock("svg", _hoisted_4, [...t[5] ||= [createElementVNode("path", { d: "M12.707 2.293l9 9c.63 .63 .184 1.707 -.707 1.707h-1v6a3 3 0 0 1 -3 3h-1v-7a3 3 0 0 0 -2.824 -2.995l-.176 -.005h-2a3 3 0 0 0 -3 3v7h-1a3 3 0 0 1 -3 -3v-6h-1c-.89 0 -1.337 -1.077 -.707 -1.707l9 -9a1 1 0 0 1 1.414 0m.293 11.707a1 1 0 0 1 1 1v7h-4v-7a1 1 0 0 1 .883 -.993l.117 -.007z" }, null, -1)]])), i.hasNewPost ? (openBlock(), createElementBlock("span", _hoisted_5, "!")) : createCommentVNode("", !0)]),
		createElementVNode("button", {
			type: "button",
			class: "topbar-icon",
			title: "Solitaire",
			"aria-label": "Solitaire",
			onClick: t[2] ||= (e) => o.navigate("solitaire")
		}, [i.activeView === "solitaire" ? (openBlock(), createElementBlock("svg", _hoisted_6, [...t[6] ||= [
			createElementVNode("path", { d: "M3.604 7.197l7.138 -3.109a.96 .96 0 0 1 1.27 .527l4.924 11.902a1 1 0 0 1 -.514 1.304l-7.137 3.109a.96 .96 0 0 1 -1.271 -.527l-4.924 -11.903a1 1 0 0 1 .514 -1.304l0 .001" }, null, -1),
			createElementVNode("path", { d: "M15 4h1a1 1 0 0 1 1 1v3.5" }, null, -1),
			createElementVNode("path", { d: "M20 6c.264 .112 .52 .217 .768 .315a1 1 0 0 1 .53 1.311l-2.298 5.374" }, null, -1)
		]])) : (openBlock(), createElementBlock("svg", _hoisted_7, [...t[7] ||= [
			createElementVNode("path", { d: "M10.348 3.169l-7.15 3.113a2 2 0 0 0 -1.03 2.608l4.92 11.895a1.96 1.96 0 0 0 2.59 1.063l7.142 -3.11a2.002 2.002 0 0 0 1.036 -2.611l-4.92 -11.894a1.96 1.96 0 0 0 -2.588 -1.064z" }, null, -1),
			createElementVNode("path", { d: "M16 3a2 2 0 0 1 1.995 1.85l.005 .15v3.5a1 1 0 0 1 -1.993 .117l-.007 -.117v-3.5h-1a1 1 0 0 1 -.117 -1.993l.117 -.007h1z" }, null, -1),
			createElementVNode("path", { d: "M19.08 5.61a1 1 0 0 1 1.31 -.53c.257 .108 .505 .21 .769 .314a2 2 0 0 1 1.114 2.479l-.056 .146l-2.298 5.374a1 1 0 0 1 -1.878 -.676l.04 -.11l2.296 -5.371l-.366 -.148l-.402 -.167a1 1 0 0 1 -.53 -1.312z" }, null, -1)
		]]))]),
		createElementVNode("button", {
			type: "button",
			class: "topbar-icon",
			...
			disabled: !i.ownerOnline,
			onClick: t[3] ||= (e) => o.navigate("chat")
		}, [i.activeView === "chat" ? (openBlock(), createElementBlock("svg", _hoisted_9, [...t[8] ||= [
			createElementVNode("path", { d: "M8 9h8" }, null, -1),
			createElementVNode("path", { d: "M8 13h6" }, null, -1),
			createElementVNode("path", { d: "M18 4a3 3 0 0 1 3 3v8a3 3 0 0 1 -3 3h-5l-5 3v-3h-2a3 3 0 0 1 -3 -3v-8a3 3 0 0 1 3 -3h12" }, null, -1)
		]])) : (openBlock(), createElementBlock("svg", _hoisted_10, [...t[9] ||= [createElementVNode("path", { d: "M18 3a4 4 0 0 1 4 4v8a4 4 0 0 1 -4 4h-4.724l-4.762 2.857a1 1 0 0 1 -1.508 -.743l-.006 -.114v-2h-1a4 4 0 0 1 -3.995 -3.8l-.005 -.2v-8a4 4 0 0 1 4 -4zm-4 9h-6a1 1 0 0 0 0 2h6a1 1 0 0 0 0 -2m2 -4h-8a1 1 0 1 0 0 2h8a1 1 0 0 0 0 -2" }, null, -1)]])), i.hasNewChatMessage ? (openBlock(), createElementBlock("span", _hoisted_11, "!")) : createCommentVNode("", !0)], 8, _hoisted_8),
		i.loginComponent ? (openBlock(), createBlock(resolveDynamicComponent(i.loginComponent), {
			key: 0,
			data: {},
			title: ""
...
var TopBarWidget_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-8396cb96"]]);
//#endregion
export { TopBarWidget_default as default };
