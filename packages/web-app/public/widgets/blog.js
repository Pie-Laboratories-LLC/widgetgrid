(function(){try{if(typeof document<`u`){var e=document.createElement(`style`);e.appendChild(document.createTextNode(`.widget-blog[data-v-3fcb772d]{box-sizing:border-box;padding:clamp(16px,4vw,32px)}.blog-status[data-v-3fcb772d]{color:#666}.post[data-v-3fcb772d]{border-bottom:1px solid #ddd;max-width:640px;margin:0 0 40px;padding-bottom:40px}.post[data-v-3fcb772d]:last-child{border-bottom:none}.post[data-v-3fcb772d]:not(.post-open){cursor:pointer}.post:not(.post-open):hover .post-title[data-v-3fcb772d]{text-decoration:underline}.post-title[data-v-3fcb772d]{margin:0 0 4px}.post-date[data-v-3fcb772d]{color:#888;margin-bottom:16px;font-size:.85rem;display:block}.post-body[data-v-3fcb772d] h1{font-size:1.2rem}.post-body[data-v-3fcb772d] img{max-width:100%;height:auto}/*$vite$:1*/`)),document.head.appendChild(e)}}catch(e){console.error(`vite-plugin-css-injected-by-js`,e)}})();
...
var __commonJSMin = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), require_google_protobuf = /* @__PURE__ */ __commonJSMin(((exports) => {
	...
	created() {
		blogClient.listBlogPosts().then((e) => {
			this.posts = e.posts, this.expandedSlug = e.posts[0]?.slug ?? null, this.status = "ready";
		}).catch(() => {
			this.status = "error";
		});
	},
	methods: {
		...
		onPostClick(e, t) {
			t.target.closest("a") || (this.expandedSlug = e.slug);
		}
	}
}, _hoisted_1 = { class: "widget widget-blog" }, _hoisted_2 = {
	key: 0,
	class: "blog-status"
}, _hoisted_3 = {
	key: 1,
	...
	key: 2,
	class: "blog-status"
}, _hoisted_5 = ["id", "onClick"], _hoisted_6 = { class: "post-title" }, _hoisted_7 = ["datetime"], _hoisted_8 = ["innerHTML"];
function _sfc_render(e, t, n, r, i, o) {
	return openBlock(), createElementBlock("div", _hoisted_1, [i.status === "loading" ? (openBlock(), createElementBlock("p", _hoisted_2, "Loading posts…")) : i.status === "error" ? (openBlock(), createElementBlock("p", _hoisted_3, "Couldn't load posts.")) : i.posts.length === 0 ? (openBlock(), createElementBlock("p", _hoisted_4, "No posts yet.")) : (openBlock(!0), createElementBlock(Fragment, { key: 3 }, renderList(i.posts, (e) => (openBlock(), createElementBlock("article", {
		key: e.slug,
		id: `post-${e.slug}`,
		class: normalizeClass(["post", { "post-open": e.slug === i.expandedSlug }]),
		onClick: (t) => o.onPostClick(e, t)
	}, [
		createElementVNode("h2", _hoisted_6, toDisplayString(e.title), 1),
		createElementVNode("time", {
			class: "post-date",
			datetime: e.publishedAt
		}, toDisplayString(o.formatDate(e.publishedAt)), 9, _hoisted_7),
		createElementVNode("div", {
			class: "post-body",
			innerHTML: e.slug === i.expandedSlug ? e.contentHtml : e.synopsisHtml
		}, null, 8, _hoisted_8)
	], 10, _hoisted_5))), 128))]);
}
var BlogWidget_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-3fcb772d"]]);
//#endregion
